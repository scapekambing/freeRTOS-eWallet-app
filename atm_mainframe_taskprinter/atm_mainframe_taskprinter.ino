...
void setup()
{
  ...
  xTaskCreate(printSerial, "serial monitor printer", 100, NULL, 2, NULL);
  xTaskCreate(pollButton1, "button1 polling", 100, NULL, 1, NULL);
  xTaskCreate(pollButton2, "button2 pollig", 100, NULL, 1, NULL);
  vTaskStartScheduler();
}
